...
// SCLPlayer
#define COCOAPODS_POD_AVAILABLE_SCLPlayer
#define COCOAPODS_VERSION_MAJOR_SCLPlayer 0
#define COCOAPODS_VERSION_MINOR_SCLPlayer 1
#define COCOAPODS_VERSION_PATCH_SCLPlayer 0
